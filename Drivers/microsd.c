...
void MICROSD_Init(void)
{
  ...
  /* IO configuration */
  GPIO_PinModeSet(MICROSD_GPIOPORTD, MICROSD_MOSIPIN, gpioModePushPull, 0);  /* MOSI */
  GPIO_PinModeSet(MICROSD_GPIOPORTD, MICROSD_MISOPIN, gpioModeInputPull, 1); /* MISO */
  GPIO_PinModeSet(MICROSD_GPIOPORTC, MICROSD_CSPIN,   gpioModePushPull, 1);  /* CS */
  GPIO_PinModeSet(MICROSD_GPIOPORTC, MICROSD_CLKPIN,  gpioModePushPull, 0);  /* CLK */
}
...
void MICROSD_Deinit(void)
{
  ...
  GPIO_PinModeSet(MICROSD_GPIOPORTD, MICROSD_MOSIPIN, gpioModeDisabled, 0);  /* MOSI */
  GPIO_PinModeSet(MICROSD_GPIOPORTD, MICROSD_MISOPIN, gpioModeDisabled, 0);  /* MISO */
  GPIO_PinModeSet(MICROSD_GPIOPORTC, MICROSD_CSPIN,   gpioModeDisabled, 0);  /* CS */
  GPIO_PinModeSet(MICROSD_GPIOPORTC, MICROSD_CLKPIN,  gpioModeDisabled, 0);  /* Clock */
}
...
{
  GPIO->P[ MICROSD_GPIOPORTC ].DOUTSET = 1 << MICROSD_CSPIN; /* CS pin high. */
...
{
  GPIO->P[ MICROSD_GPIOPORTC ].DOUTCLR = 1 << MICROSD_CSPIN; /* CS pin low. */
  if (WaitReady() != 0xFF)
  {
    MICROSD_Deselect();
    return 0;
